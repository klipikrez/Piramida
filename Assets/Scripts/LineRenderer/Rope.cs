...
public class Rope : MonoBehaviour
{
    ...
    public float spinSpeed = 165f;
    public Quaternion aa;
    ...
    void Update()
    {
        ...
        for (int i = 1; i < lineRenderer.positionCount - 1; i++)
        {
            ...
            lineRenderer.SetPosition(i, PointAtRatio(T1.position + T1Offset, T2.position, i, lineRenderer.positionCount - (i)) + (offset/*new Vector3(
                Mathf.Sin((i + Time.timeSinceLevelLoad * 5) / 4f),
                 Mathf.Cos((i + Time.timeSinceLevelLoad * 5) / 4f),
                  0)*/
